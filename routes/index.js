 ...
 */
const routes = {
	"v1/typeorm": require('@routes/v1/typeorm.route'),
...
module.exports = (io) => {
    ...
    // the sanitizes the requests and prevents people frmo using a user_id that they can't authenticate.
...
const createEndpoint = (io, key, verb) => {
